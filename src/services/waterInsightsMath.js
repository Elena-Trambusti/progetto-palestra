/** Stessa logica di `server/lib/waterInsights.js` (modalità mock senza backend). */
...
export function computeWaterEta(readings, currentWater, opts = {}) {
  ...
  const hoursTo = (currentWater - criticalPct) / (-slope) / MS_PER_HOUR;
...
export function detectRapidDrop(readings, currentWater, opts = {}) {
